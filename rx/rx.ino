...
// ─── BLE UUIDs ───────────────────────────────────────────────
#define BLE_DEVICE_NAME "vicky-1"
...
void publishPacket(const data_pkt_t& pkt, int rssi, float snr) {
  ...
  // ── Dedup best-effort: ¿ya lo publicó otro RX? ───────────────
  ...
  // Tu publicación de datos normal (sin cambios)
  char topic[128];
